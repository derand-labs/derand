...
var standardClassgroupZKPlonkBn254Template = template.Must(
	template.New("standard_classgroup_zk_plonk_bn254_template").Parse(`
{{ .plonk_verifier }}
...
contract Verifier {
    ...
    uint16 constant D_BITS = {{ .d_bits }};
    uint16 constant LIMB_BITS = {{ .limb_bits }};
