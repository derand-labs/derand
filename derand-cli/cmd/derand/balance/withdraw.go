...
var withdrawCmd = &cobra.Command{
	Use:   "withdraw",
	Short: "withdraw from derand to current balance",
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if len(args) > 1 {
			return fmt.Errorf("Usage: derand withdraw [amount]")
		}
		...
		tx, err := derand.Withdraw(currentTxOpts, amount)
		if err != nil {
		...
		utils.PrintTitle("Withdrawing", args[0], "ETH from DeRand")
